...
class MainMenuState extends MusicBeatState
{
	...
	public static var kadeEngineVer:String = "T3BZ-engine 1.0" + nightly;
	...
	override function create()
	{
		...
		versionShit.setFormat("VCR OSD Mono", 16, FlxColor.WHITE, LEFT, FlxTextBorderStyle.OUTLINE, FlxColor.ORANGE);
		add(versionShit);
