...
class PauseSubState extends MusicBeatSubstate
{
	...
	var menuItems:Array<String> = ['Resume','Restart Song','Retourner dans le freeplay','Aller dans les options', 'Exit to menu'];
	...
	override function update(elapsed:Float)
	{
		...
		if (accepted)
		{
			...
			switch (daSelected)
			{
				...
				case "Restart Song":
					FlxG.resetState();
				case 'Retourner dans le freeplay':
				FlxG.switchState(new FreeplayState());
				trace("Freeplay Menu Selected");
				
				case 'Aller dans les options':
